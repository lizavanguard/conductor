...
namespace Conductor.Game.Model
{
    ...
    {
        static readonly int[] AllConditionTypes = (Enum.GetValues(typeof(SoldierConditionType)) as SoldierConditionType[]).Select(c => (int)c).ToArray();
        ...
        {
            tempNodeList.Clear();
            AppendNewNodeRecursively(0, new int[0], new int[0], operationType);
